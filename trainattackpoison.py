...
from snakeai.gameplayAttackPoison.environmentattackpoison import EnvironmentAttackPoison
from snakeai.gameplayAttackRandomPoison.environmentattackrandompoison import EnvironmentAttackRandomPoison
...
def create_snake_environment(level_filename):
    ...
    return EnvironmentAttackPoison(config=env_config, verbose=1)
...
def create_snake_environment4eat(level_filename):
    ...
    return EnvironmentAttackRandomPoison(config=env_config, verbose=1)
